...
public class BasicDoubleLinkedListTest {
    ...
    public void setUp() throws Exception {
        ...
        //System.out.println(linkedCar.toArrayList());
    ...
    public void testRemove() {
        ...
        System.out.println(linkedCar.getSize() + " " + linkedCar.toArrayList());
        System.out.println(linkedCar.getFirst());
    ...
    public void testRetrieveFirstElement() {
       // System.out.println(linkedCar.getSize());
      //  System.out.println(linkedCar.toArrayList());
